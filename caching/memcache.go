...
// MemcachedStore represents the caching with memcached persistence
...
func (c *MemcachedStore) invoke(storeFn func(*memcache.Client, *memcache.Item) error, key string,
